...
public class OrderAdminListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<OrderDetailDto> orderAdminList = oDao.orderAdminList(startRow, endRow);
		System.out.println();
		request.setAttribute("orderAdminList", orderAdminList);
		int totCnt = oDao.orderAllTotCnt();// 글갯수
